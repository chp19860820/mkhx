...
public class GetFriendEnergy extends com.mkhx.tool.base.ToolBase {
	protected String requestHost = super.defaultDestHost;
	protected String requestPath = super.getFriendEnergyPath;
	protected String requestURL = super.defaultDestHost + super.getFriendEnergyPath;
	protected String requestBody = null;
	protected String cookie = null;
	protected String responseText = null;

	public GetFriendEnergy(String cookie) {
		this.cookie = cookie;
	}

	public GetFriendEnergy(String cookie, String requestHost) {
		this.cookie = cookie;
